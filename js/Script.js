...
function Bindata() {
  ...
  // Clic al mostrar el boton Ver más.
  jQuery(".home .home__block .button").click(function () {
    /*Seleccionar id de seccion*/
    var id = ".home";
    /* This Hace referencia al elemento que le estamos haciendo click/ attr trabajar con el atributo */
    jQuery("html,body").animate({
  ...
  //clic al mostrar seccion desde el footer
  jQuery(".footer .container .footer__list a").click(function () {
    /*Seleccionar id de seccion*/
    var id = jQuery(this).attr("href");
    /* This Hace referencia al elemento que le estamos haciendo click/ attr trabajar con el atributo */
    jQuery("html,body").animate({
